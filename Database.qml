...
QtObject {
    ...
    function insertTestData(ti, rhi, td, ta, rha, mode, id, instrument_name, airLine_name, detector_name, airbag_no, gas_conc, result, flow_rt, press_rt, no_rt, detector_no, sensor_no, sensor_standard) {
        root._database().transaction(function (tx) {
            tx.executeSql(
                        'INSERT INTO test_data (ti, rhi, td, ta, rha, mode, job_id, instrument_name, airLine_name, detector_name, airbag_no, gas_conc, result, flow_rt, press_rt, no_rt, detector_no, sensor_no, sensor_standard) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)',
                        [ti, rhi, td, ta, rha, mode, id, instrument_name, airLine_name, detector_name, airbag_no, gas_conc, result, flow_rt, press_rt, no_rt, detector_no, sensor_no, sensor_standard])
        })
    }
